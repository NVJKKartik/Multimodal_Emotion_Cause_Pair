...
tf.compat.v1.app.flags.DEFINE_string('w2v_file', './data/ECF_glove_300.txt', 'embedding file')
tf.compat.v1.app.flags.DEFINE_string('path', './data/', 'path for dataset')
tf.compat.v1.app.flags.DEFINE_string('video_emb_file', './data/video_embedding_4096.npy', 'ndarray (13620, 4096)')
tf.compat.v1.app.flags.DEFINE_string('audio_emb_file', './data/audio_embedding_6373.npy', 'ndarray (13620, 6373)')
tf.compat.v1.app.flags.DEFINE_string('video_idx_file', './data/video_id_mapping.npy', 'mapping dict: {dia1utt1: 1, ...}')
...
## input struct ##
tf.compat.v1.app.flags.DEFINE_integer('max_sen_len', 35, 'max number of tokens per sentence')
tf.compat.v1.app.flags.DEFINE_integer('pred_future_cause', 1, 'whether consider the cause among future utterances')
## model struct ##
tf.compat.v1.app.flags.DEFINE_string('choose_emocate', '', 'whether choose emocate')
tf.compat.v1.app.flags.DEFINE_integer('emocate_eval', 6, 'Whether to save the best evaluation score of w-avg 6 or w-avg 4')
tf.compat.v1.app.flags.DEFINE_string('use_x_v', '', 'whether use video embedding')
tf.compat.v1.app.flags.DEFINE_string('use_x_a', '', 'whether use audio embedding')
...
# >>>>>>>>>>>>>>>>>>>> For Training <<<<<<<<<<<<<<<<<<<< #
tf.compat.v1.app.flags.DEFINE_integer('batch_size', 200, 'number of example per batch')
...
tf.compat.v1.app.flags.DEFINE_float('keep_prob2', 1.0, 'softmax layer dropout keep prob')
...
tf.compat.v1.app.flags.DEFINE_string('scope', 'TEMP', 'scope')
tf.compat.v1.app.flags.DEFINE_string('log_file_name', 'step2.log', 'name of log file')
tf.compat.v1.app.flags.DEFINE_string('save_pair', 'yes', 'whether save predicted pairs')
tf.compat.v1.app.flags.DEFINE_string('step1_file_dir', 'step1/', 'file directory of step1')
...
def build_model(embeddings, placeholders, RNN=biLSTM):
    ...
    inputs = tf.nn.dropout(inputs, rate = 1 - (is_training * FLAGS.keep_prob1 + (1.-is_training)))
